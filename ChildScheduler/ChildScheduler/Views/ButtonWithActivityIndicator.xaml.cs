...
namespace ChildScheduler.Views
{
    public partial class ButtonWithActivityIndicator
    {
        ...
        public static readonly BindableProperty ButtonColorProperty = BindableProperty.Create(nameof(ButtonColor), typeof(Color),
            typeof(ButtonWithActivityIndicator), null,
             propertyChanged: (bindable, oldVal, newVal) => ((ButtonWithActivityIndicator)bindable).OnButtonColorChanged((Color)newVal));
        public static readonly BindableProperty BorderButtonColorProperty = BindableProperty.Create(nameof(ButtonColor), typeof(Color),
            typeof(ButtonWithActivityIndicator), null,
             propertyChanged: (bindable, oldVal, newVal) => ((ButtonWithActivityIndicator)bindable).OnBorderButtonColorChanged((Color)newVal));
        ...
        private async void OnButtonColorChanged(Color color)
        {
            InnerButton.BackgroundColor = color;
        }
        private async void OnBorderButtonColorChanged(Color color)
        {
            InnerButton.BorderColor = color;
        }
